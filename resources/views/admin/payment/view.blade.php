                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ${payment.requirement.schedule_start ? `<p class="mb-0"><strong>Schedule:</strong> ${new Date(payment.requirement.schedule_start).toLocaleDateString('en-IN')} to ${new Date(payment.requirement.schedule_end).toLocaleDateString('en-IN')}</p>` : ''}
                        </div>
                    </div>
                </div>
            ` : ''}
