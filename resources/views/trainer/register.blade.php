                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="trainerSignupForm" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <label class="form-label" for="addr_line1">Address Line 1 <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="addr_line2" name="addr_line2"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="district" name="district"
                                        placeholder="Mumbai Suburban" required>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-12">
                                    <label class="form-label" for="biodata">Bio/About Yourself <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" id="biodata" name="biodata" rows="3"
                                        placeholder="Tell us about your experience and expertise..." required></textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="achievements" name="achievements" rows="3"
                                        placeholder="List your key achievements and certifications..."></textarea>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="for_org_type">Organization Type <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="availability">Availability <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="training_mode">Training Mode <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="row g-3 mb-4">
                                <!-- Profile Picture -->
                                <div class="col-md-6">
                                    <label class="form-label" for="profile_pic">Profile Picture <span
                                            class="text-danger">*</span></label>
                                    ...
                                    <div id="profile_pic_preview" class="mt-3 d-none">
                                        <div class="position-relative d-inline-block">
                                            <img id="profile_pic_img" src="" alt="Profile Preview" class="img-thumbnail"
                                                style="max-width: 200px; max-height: 200px;">
                                            <button type="button"
                                                class="btn btn-sm btn-danger position-absolute top-0 end-0 m-1 rounded-circle"
                                                id="remove_profile_pic" style="width: 30px; height: 30px; padding: 0;">
                                                <i class="bx bx-x"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <!-- Signed Form PDF -->
                                <div class="col-md-6">
                                    <label class="form-label" for="signed_form_pdf">Signed Agreement Form</label>
                                    <input type="file" class="form-control" id="signed_form_pdf" name="signed_form_pdf"
                                        accept=".pdf">
