                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100">
                            @if ($req->program->image)
                                <img src="{{ asset('storage/' . $req->program->image) }}" class="card-img-top"
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <ul class="list-unstyled mb-3">
                                    ...
                                    <li class="mb-1">
                                        ...
                                        ₹{{ number_format($req->program->cost * $req->number_of_students, 2) }}
                                    </li>
                                    <li class="mb-1">
                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="dataTables_info" role="status" aria-live="polite">
                                Showing {{ $requirements->firstItem() }} to {{ $requirements->lastItem() }} of
                                {{ $requirements->total() }} entries
                            </div>
                        </div>
                                ...
                                <ul class="pagination justify-content-center justify-content-md-end">
                                    ...
                                    @else
                                        <li class="paginate_button page-item previous">
                                            <a href="{{ $requirements->previousPageUrl() }}" class="page-link"><i
                                    ...
                                    @if($end < $requirements->lastPage())
                                        ...
                                        @endif
                                        <li class="paginate_button page-item">
                                            <a href="{{ $requirements->url($requirements->lastPage()) }}"
                                                class="page-link">{{ $requirements->lastPage() }}</a>
                                        </li>
                                    @endif
                                    ...
                                    @if ($requirements->hasMorePages())
                                        <li class="paginate_button page-item next">
                                            <a href="{{ $requirements->nextPageUrl() }}" class="page-link"><i
