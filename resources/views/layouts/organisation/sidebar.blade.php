        ...
        <li class="menu-item {{ request()->routeIs('org.programs.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('org.programs.index') ? 'active' : '' }}">
                    <a href="{{ route('org.programs.index') }}" class="menu-link"><i
                            class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="All Programs">All Programs</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->routeIs('org.programs.view.requested') ? 'active' : '' }}">
                    <a href="{{ route('org.programs.view.requested') }}" class="menu-link"><i
                            class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="My Programs">Requested Programs</div>
                    </a>
                </li>
            </ul>
        </li>

        <li class="menu-item {{ request()->routeIs('org.active-programs.*') ? 'active' : '' }}">
            <a href="{{ route('org.active-programs.index') }}" class="menu-link"><i
                    class="menu-icon tf-icons bx bx-check-circle"></i>
                <div data-i18n="Active Programs">Active Programs</div>
            </a>
        </li>
